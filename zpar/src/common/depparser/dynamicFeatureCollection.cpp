...
DynamicFeatureCollection::DynamicFeatureCollection() {
	...
	using namespace std;
	vw* model = VW::initialize("--hash all -q st --noconstant -i /Users/augustofheart/Downloads/vowpal_wabbit-master/library/train.w -f /Users/augustofheart/Downloads/vowpal_wabbit-master/library/train2.vw");
