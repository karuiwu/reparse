...
public:
   ...
   CTwoTaggedWordsIntMap m_mapSRtN0wt;
   CTwoTaggedWordsIntMap m_mapSRwtN0t;
   CTagSet2IntMap m_mapSRtN0t;
...
public:
   ...
   CWeight(const std::string &sPath, bool bTrain) : CWeightBase(sPath, bTrain) ,
                                               ...
                                               m_mapSRtN0wt("StackRootTagNextWordTag", 122651),
                                               m_mapSRwtN0t("StackRootWordTagNextTag", 122651),
                                               m_mapSRtN0t("StackRootTagNextTag", 122651)
   { loadScores(); }
