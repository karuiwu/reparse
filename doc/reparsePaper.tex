...
In order to determine when the parser should use revision actions, an oracle was used to determine when the parser had entered an error state.
...
when submitting your paper for review.\cite{textbook,goldberg}
