...
public class KBestList {
	 ...
	 * 
	 * @param decision
	 *            a reference to the single decision that uses the k-best list
	 */
	 ...
	 * 
	 * @param actionCode
	 *            the integer representation of candidate action
	...
	public void addList(int[] predictionList) throws MaltChainedException {
		int n = (k != -1 && k <= predictionList.length - 1) ? k
	...
	public boolean updateActionWithNextKBest() throws MaltChainedException {
		if (addCandidateIndex != 0 && topCandidateIndex < addCandidateIndex
	...
	public String toString() {
		...
		// return this.kBestList.toString();
