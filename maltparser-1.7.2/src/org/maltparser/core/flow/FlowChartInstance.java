...
//	}
	...
	public int process()  throws MaltChainedException {
		...
		for (ChartItem chartItem : chartItems) {
			...
			//TODO check out each chartItem object. Probably contains valuable information.
			// Each chart item seems to call different process function calls. Took a while to figure that out.
			
//			System.err.println("JUNEKI: chartItem " + chartItem);
