...
public class ReadChartItem extends ChartItem {
	...
	public int process(int signal) throws MaltChainedException {
		...
		// JUNEKI: This is it. This is where the connll data is being read in. ReadChartItem.java line 85. This is character by character.
		boolean moreInput = reader.readSentence(cachedGraph); // JUNEKI: oh god I found it. This is where the next section of Connll data is.
		
		// At this point the connll data is stored in cachedGraph!!
		System.out.println("JUNEKI: The connll data is being read in ReadChartItem.java line 89");
