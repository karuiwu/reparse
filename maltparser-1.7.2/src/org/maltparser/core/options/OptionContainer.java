...
public class OptionContainer implements Comparable<OptionContainer>{
	...
	private SortedMap<Option,Object> commandLineOptionMap;			// JUNEKI: Why was this really necessary?
	...
	public void addOptionValue(int type, Option option, Object value) throws OptionException {
		if (type == OptionContainer.SAVEDOPTION) {
			...
			commandLineOptionMap.put(option, value); 	// JUNEKI: commandLineOptionMap has our command line file specification.
