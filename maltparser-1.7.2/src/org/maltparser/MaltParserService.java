...
//	private URL urlMaltJar;
	...
	public void runExperiment(String commandLine) throws MaltChainedException {
		...
		OptionManager.instance().parseCommandLine(commandLine, optionContainer); // JUNEKI: This just parses in the command line arguments. Nothing really happens here except that all of the options are read in as part of the object structure.
		engine = new Engine();
		engine.initialize(optionContainer); // JUNEKI: I don't think what Im looking for happens here. It just loads in what it needs to preprocess, process, and postprocess.
	...
	private void initialize() throws MaltChainedException {
		...
		System.err.println(OptionManager.instance());
